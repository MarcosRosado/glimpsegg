...
import { generateMatchInsights, ALL_RULES } from './index';
...
import { BuildAdvice, BuildVerdict } from '../buildAdvisor';
import { ThreatProfile } from './threatProfile';
import { CoachingInsight, MatchDeathEvent } from '../../types/dota';
